...
export const navigationListenerProps = {
    onTransitionEnd: (props, ...args) => executeNavigationListeners("transitionEnd", ...args),
    onTransitionStart: (props, ...args) => executeNavigationListeners("transitionStart", ...args),
    onGestureStart: (props, ...args) => executeNavigationListeners("gestureStart", ...args),
    onGestureEnd: (props, ...args) => executeNavigationListeners("gestureEnd", ...args),
    onGestureCancel: (props, ...args) => executeNavigationListeners("gestureCancel", ...args),
};
